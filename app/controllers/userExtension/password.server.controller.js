...
var _ = require('lodash'),
	...
	settingsController = require('../settings.server.controller');
...
exports.forgot = function(req, res, next) {
	async.waterfall([
		...
		function(emailHTML, user, done) {
			settingsController.getDefaultEmailSettings(function(emailSettings) {
				if (emailSettings) {
					...
					return res.status(400).send({
						message: 'Email setting my be blank'
					});
				}
			});
