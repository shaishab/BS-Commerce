...
angular.module('bsadmins').directive('incompleteOrdersStatistics', ['orderService',
    function(orderService) {
        return {
            restrict: 'AE',
            replace: true,
            templateUrl: 'modules/bsadmins/views/dashboard/incomplete-orders-statistics.html',
